...
public class Lunar {
    ...
    public static String getDayNongli(int year,int mouth,int day){
    	 Calendar today = Calendar.getInstance();
         try {
			today.setTime(chineseDateFormat.parse(year+"年"+mouth+"月"+day+"日"));
		} catch (ParseException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
         Lunar lunar = new Lunar(today);
         String yi=lunar.toString();
         String s=yi.substring(yi.length()-2, yi.length());
		return s;
